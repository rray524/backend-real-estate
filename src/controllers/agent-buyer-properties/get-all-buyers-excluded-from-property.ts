...
import { getBuyersExcludedFromProperty } from "../../helpers/agent-buyer-property-helper";
import { IUser } from "../../types/user-types";

const getAllBuyersExcludedFromProperty = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
...
export default getAllBuyersExcludedFromProperty;
